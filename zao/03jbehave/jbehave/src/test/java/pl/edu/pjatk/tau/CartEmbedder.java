...
@Configure(storyControls = CartEmbedder.MyStoryControls.class, storyLoader = CartEmbedder.MyStoryLoader.class, storyReporterBuilder = CartEmbedder.MyReportBuilder.class,
...
public class CartEmbedder extends InjectableEmbedder {
    ...
    public static class MyStoryLoader extends LoadFromClasspath {
        public MyStoryLoader() {
            super(CartEmbedder.class.getClassLoader());
        }
    }
